...
// installService attempts to install the bitmemed service. Typically this should
...
// removeService attempts to uninstall the bitmemed service. Typically this should
...
// startService attempts to Start the bitmemed service.
