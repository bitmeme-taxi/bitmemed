...
import (
	...
	"github.com/bitmeme-taxi/bitmemed/infrastructure/os/execenv"
	"github.com/bitmeme-taxi/bitmemed/infrastructure/os/limits"
	"github.com/bitmeme-taxi/bitmemed/infrastructure/os/signal"
	"github.com/bitmeme-taxi/bitmemed/infrastructure/os/winservice"
...
var serviceDescription = &winservice.ServiceDescription{
	Name:        "bitmemedsvc",
	DisplayName: "Bitmemed Service",
	Description: "Downloads and stays synchronized with the Bitmem blockDAG and " +
...
// StartApp starts the bitmemed app, and blocks until it finishes running
func StartApp() error {
...
func (app *kaspadApp) main(startedChan chan<- struct{}) error {
	...
	if err != nil {
		log.Errorf("Unable to start bitmemed: %+v", err)
		return err
	}

	defer func() {
		log.Infof("Gracefully shutting down bitmemed...")
		...
		log.Infof("Bitmemed shutdown complete")
	}()
