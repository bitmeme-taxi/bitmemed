...
import (
	...
	"github.com/bitmeme-taxi/bitmemed/domain/consensus/utils/merkle"
	"github.com/bitmeme-taxi/bitmemed/domain/consensus/utils/mining"
	"github.com/bitmeme-taxi/bitmemed/domain/consensus/utils/pow"
	"github.com/bitmeme-taxi/bitmemed/domain/consensus/utils/testutils"
	"github.com/bitmeme-taxi/bitmemed/util/difficulty"
...
func TestPOW(t *testing.T) {
	...
	testutils.ForAllNets(t, false, func(t *testing.T, consensusConfig *consensus.Config) {
		...
		if consensusConfig.Name != "bitmeme-mainnet" {
