...
import (
	...
	"github.com/bitmeme-taxi/bitmemed/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that bitmemed doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
