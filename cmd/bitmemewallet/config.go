...
type createConfig struct {
	KeysFile          string `long:"keys-file" short:"f" description:"Keys file location (default: ~/.bitmemewallet/keys.json (*nix), %USERPROFILE%\\AppData\\Local\\Kaspawallet\\key.json (Windows))"`
...
type sendConfig struct {
	...
	FromAddresses            []string `long:"from-address" short:"a" description:"Specific public address to send BTM from. Repeat multiple times (adding -a before each) to accept several addresses" required:"false"`
